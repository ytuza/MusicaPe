...
public class Album {
     ...
     * @param id
     */
    public Album(String albumType, List<Artist> artists, List<String> availableMarkets, ExternalUrls_ externalUrls, String href, String id, List<Image> images, String name, String releaseDate, String releaseDatePrecision, Integer totalTracks, String type, String uri) {
        super();
